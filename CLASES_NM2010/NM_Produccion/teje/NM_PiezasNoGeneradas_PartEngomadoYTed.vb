...
Namespace NM_Tejeduria
    Public Class NM_PiezasNoGeneradas_PartEngomadoYTed
        ...
        Public Function exist(ByVal pFecha As String, ByVal pCodigo_Pieza As String) As Boolean
            ...
            sql.Append("Select * from NM_Piezas_NoGeneradas_PartEngomadoYTed ")
        ...
        Public Function Add(ByVal pFecha As String, ByVal pCodigo_pieza As String, _
            ...
            Dim sql As New System.Text.StringBuilder, objConn As New NM_Consulta
            Try
                sql.Append("Insert into NM_Piezas_NoGeneradas_PartEngomadoYTed(Fecha, Codigo_pieza,Codigo_origen,")
        ...
        Public Function Update() As Boolean
            Dim sql As New System.Text.StringBuilder, objConn As New NM_Consulta
            Try
                sql.Append("Update NM_Piezas_NoGeneradas_PartEngomadoYTed ")
                sql.Append("set ")
        ...
        Public Function Delete() As Boolean
            Dim sql As New System.Text.StringBuilder, objConn As New NM_Consulta
            Try
                sql.Append("Delete from NM_Piezas_NoGeneradas_PartEngomadoYTed ")
        ...
        Public Function List() As DataTable
            ...
            sql = "Select * from NM_Piezas_NoGeneradas_PartEngomadoYTed "
        ...
        Public Function Exist(ByVal pcodigoPieza As String, ByVal pCampoPieza As Boolean) As Boolean
            Dim objconn As New NM_Consulta, sql As New System.Text.StringBuilder
            sql.Append("select codigo_pieza from NM_Piezas_NoGeneradas_PartEngomadoYTed ")
        ...
        Public Function Exist(ByVal pAnno As Integer) As Boolean
            Dim objconn As New NM_Consulta, sql As New System.Text.StringBuilder
            sql.Append("select fecha from NM_Piezas_NoGeneradas_PartEngomadoYTed ")
