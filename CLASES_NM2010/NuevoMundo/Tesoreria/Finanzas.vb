...
#Region "ENVIO DE LETRAS A BANCOS"
        ...
        ByVal strEstado1 As String, ByVal strEstado2 As String) As DataTable
            ...
            End Try
        End Function
        Function ObtenerLetrasNoAsignadasBancoOrdenFiltro(ByVal pstr_CodigoCliente As String, ByVal pstr_CodigoMoneda As String, _
                ByVal pstr_NombreCliente As String, ByVal pnum_Importe As Double, ByVal pstr_FechaVencimiento As String, _
                ByVal strEstado1 As String, ByVal strEstado2 As String, ByVal strFlg As String) As DataTable
            Try
                Dim objParametros() As Object = {"var_CodigoCliente", pstr_CodigoCliente, "var_NombreCliente", pstr_NombreCliente, _
                "var_FechaVencimiento", pstr_FechaVencimiento, "num_ImporteLetra", pnum_Importe, "var_TipoMoneda", pstr_CodigoMoneda, _
                "var_Estado1", strEstado1, "var_Estado2", strEstado2, "var_flg", strFlg}
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.Intranet)
                Return _objConexion.ObtenerDataTable("usp_TES_LetrasEnvioBanco_Obtener_orden", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
...
#End Region
        ...
        Public Function ObtenerCajasValidasEgresos(ByVal strTipoParam As String, ByVal strCodCaja As String, ByVal strCodComprobante As String, ByVal strAnio As String, ByVal strMes As String) As DataTable
            Dim objParametros() As Object = {"p_vch_tipo_busqueda", strTipoParam,
                                             "p_vch_codigo_caja", strCodCaja,
                                             "p_vch_codigo_comprobante", strCodComprobante,
                                             "p_vch_anio", strAnio,
                                             "p_vch_mes", strMes}
            Try
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.TesoreriaOfisis)
                Return _objConexion.ObtenerDataTable("usp_teso_ofisis_egreso_caja", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Public Function generarAsientoContable(ByVal strUnidContable As String, ByVal strFecha As String, ByVal intAnio As Integer, ByVal intMes As Integer, ByVal strCaja As String, ByVal strComprobante As String) As DataTable
            Dim objParametros() As Object = {"p_vch_uni_cntb", strUnidContable,
                                             "p_vch_fecha", strFecha,
                                             "p_int_anio", intAnio,
                                             "p_int_mes", intMes,
                                             "p_vch_caja", strCaja,
                                             "p_vch_comprobante", strComprobante}
            Try
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.TesoreriaOfisis)
                Return _objConexion.ObtenerDataTable("usp_teso_ofisis_generar_asiento", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Public Function egresosCajaOrdenesTrabajo(ByVal strTipoParam As String, ByVal strNuSecu As String, ByVal strCodCaja As String, ByVal strCodComprobante As String, ByVal strAnio As String, ByVal strMes As String, ByVal strOrdTra As String) As DataTable
            Dim objParametros() As Object = {"p_vch_tipo_busqueda", strTipoParam,
                                             "p_vch_nu_secu", strNuSecu,
                                             "p_vch_codigo_caja", strCodCaja,
                                             "p_vch_codigo_comprobante", strCodComprobante,
                                             "p_vch_anio", strAnio,
                                             "p_vch_mes", strMes,
                                             "p_vch_ord_tra", strOrdTra}
            Try
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.TesoreriaOfisis)
                Return _objConexion.ObtenerDataTable("usp_teso_ofisis_egreso_caja_OT", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Public Function inertarRegistroCajaChicaxComprobante(ByVal strCodigoCaja As String, ByVal strAnio As String, ByVal strMes As String, ByVal strComprobante As String, ByVal strTipMovi As String,
                                                             ByVal strCodCuentaCtb As String, ByVal strCodOrdServ As String, ByVal strTipEnti As String, ByVal strCodEnti As String, ByVal strTipDocu As String,
                                                             ByVal strCodDocu As String, ByVal strCodMoneda As String, ByVal strCodFecha As String, ByVal dblImpDocu As Double, ByVal dblImSalDocu As Double,
                                                             ByVal dblImSalConv As Double, ByVal dblImDeta As Double, ByVal dblImDetaNega As Double, ByVal dblConvDocu As Double, ByVal dblConvPart As Double,
                                                             ByVal strObser As String, ByVal strStCier As String, ByVal strUsuario As String, ByVal dblTipCambio As Double, ByVal strSubRubro As String,
                                                             ByVal strCodResp As String, ByVal strOrdTrab As String) As DataTable
            Dim objParametros() As Object = {"p_vch_codigo_caja", strCodigoCaja,
                                             "p_vch_anio", strAnio,
                                             "p_vch_mes", strMes,
                                             "p_vch_codigo_comprobante", strComprobante,
                                             "p_vch_ti_movi", strTipMovi,
                                             "p_vch_co_cnta", strCodCuentaCtb,
                                             "p_vch_co_ord_serv", strCodOrdServ,
                                             "p_vch_ti_enti", strTipEnti,
                                             "p_vch_co_enti", strCodEnti,
                                             "p_vch_ti_docu", strTipDocu,
                                             "p_vch_co_docu", strCodDocu,
                                             "p_vch_co_mone", strCodMoneda,
                                             "p_vch_fe_docu", strCodFecha,
                                             "p_num_im_docu", dblImpDocu,
                                             "p_num_im_sal_docu", dblImSalDocu,
                                             "p_num_im_sal_conv", dblImSalConv,
                                             "p_num_im_deta", dblImDeta,
                                             "p_num_im_deta_nega", dblImDetaNega,
                                             "p_num_conv_docu", dblConvDocu,
                                             "p_num_conv_part", dblConvPart,
                                             "p_vch_obse", strObser,
                                             "p_vch_st_cier", strStCier,
                                             "p_vch_usuario", strUsuario,
                                             "p_num_tip_cambio", dblTipCambio,
                                             "p_vch_sub_rubro", strSubRubro,
                                             "p_vch_co_resp", strCodResp,
                                             "p_vch_nu_ord_tra", strOrdTrab
                                            }
            Try
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.TesoreriaOfisis)
                Return _objConexion.ObtenerDataTable("usp_teso_ofisis_egreso_caja_insert", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Public Function actualizarRegistroCajaChicaxComprobante(ByVal intNumSecu As Integer, ByVal strCodigoCaja As String, ByVal strAnio As String, ByVal strMes As String, ByVal strComprobante As String, ByVal strTipMovi As String,
                                                             ByVal strCodCuentaCtb As String, ByVal strCodOrdServ As String, ByVal strTipEnti As String, ByVal strCodEnti As String, ByVal strTipDocu As String,
                                                             ByVal strCodDocu As String, ByVal strCodMoneda As String, ByVal strCodFecha As String, ByVal dblImpDocu As Double, ByVal dblImSalDocu As Double,
                                                             ByVal dblImSalConv As Double, ByVal dblImDeta As Double, ByVal dblImDetaNega As Double, ByVal dblConvDocu As Double, ByVal dblConvPart As Double,
                                                             ByVal strObser As String, ByVal strStCier As String, ByVal strUsuario As String, ByVal dblTipCambio As Double, ByVal strSubRubro As String,
                                                             ByVal strCodResp As String, ByVal strOrdTrab As String) As DataTable
            Dim objParametros() As Object = {"p_int_NumSecu", intNumSecu,
                                             "p_vch_codigo_caja", strCodigoCaja,
                                             "p_vch_anio", strAnio,
                                             "p_vch_mes", strMes,
                                             "p_vch_codigo_comprobante", strComprobante,
                                             "p_vch_ti_movi", strTipMovi,
            ...
            Try
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.TesoreriaOfisis)
                Return _objConexion.ObtenerDataTable("usp_teso_ofisis_egreso_caja_update", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Public Function obtenerDocumentosProveedor(ByVal strAccion As String, ByVal strCodProv As String, ByVal strTipDoc As String, ByVal strNumDoc As String) As DataTable
            Dim objParametros() As Object = {"p_vch_accion", strAccion,
                                             "p_vch_co_prov", strCodProv,
                                             "p_vch_tip_docu", strTipDoc,
                                             "p_vch_num_docu", strNumDoc}
            Try
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.TesoreriaOfisis)
                Return _objConexion.ObtenerDataTable("USP_TESO_OBTENER_DOCU_PROVI", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Public Function validarCtaGasto(ByVal strCtaGasto As String) As DataTable
            Dim objParametros() As Object = {"pvchCtaGasto", strCtaGasto}
            Try
                _objConexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.ContabilidadOfisis)
                Return _objConexion.ObtenerDataTable("USP_CONT_VALIDARCUENTAGASTO_OT", objParametros)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
