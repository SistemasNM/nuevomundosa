        ...
        Public Shared Function ObtenerCadenaConexionSQLServer(ByVal BaseDatos As enmBasesDatos) As String
            Try
                ...
                Select Case BaseDatos
                    ...
                    Case Is = enmBasesDatos.NMEVALDESEMP
                        strServidor = CType(Registry.LocalMachine.OpenSubKey("Software\NuevoMundo\NMEVALDESEMP").GetValue("server"), String)
                        strBaseDatos = CType(Registry.LocalMachine.OpenSubKey("Software\NuevoMundo\NMEVALDESEMP").GetValue("BD"), String)
                        strUsuario = CType(Registry.LocalMachine.OpenSubKey("Software\NuevoMundo\NMEVALDESEMP").GetValue("user"), String)
                        strPassword = CType(Registry.LocalMachine.OpenSubKey("Software\NuevoMundo\NMEVALDESEMP").GetValue("passwd"), String)
                End Select

                Return String.Format(m_strCadenaConexionSQLServer, _
                    strServidor, _
                    strBaseDatos, _
                    strUsuario, _
                    strPassword)
