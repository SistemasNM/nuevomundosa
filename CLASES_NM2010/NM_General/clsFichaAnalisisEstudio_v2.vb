...
Public Class clsFichaAnalisisEstudio_v2
#Region "Variables"
...
#End Region
    ...
    Sub setearParametros(ByVal ObjclsFichaAnalisisEstudio As clsFichaAnalisisEstudio_v2)
    ...
    Function CRUDFichaAnalisisEstudio(ByVal ObjclsFichaAnalisisEstudio As clsFichaAnalisisEstudio_v2) As DataTable
        Try
            ...
            Return _objConexion.ObtenerDataTable("USP_ATE_UTB_FICHA_ANALISIS_ESTUDIO_MANTENEDOR_V2", objParametros)
