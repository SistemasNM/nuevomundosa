...
Public Class clsAnalisisTela_v2
#Region "Variables"
...
#End Region
    ...
    Sub setearParametros(ByVal ObjclsAnalisisTela As clsAnalisisTela_v2)
    ...
    Function CRUDRequerimientos(ByVal ObjclsAnalisisTela As clsAnalisisTela_v2) As DataTable
        Try
            ...
            Return _objConexion.ObtenerDataTable("USP_ATE_UTB_REQUER_ATELA_MANTENEDOR_V2", objParametros)
