...
#Region " Definicion de Metodos "
        ...
        Public Function Listar(ByVal pFlag As String) As DataTable
            Dim dtblDatos As DataTable
            Dim objParametros() As Object = {"flag", pFlag}
            Try
                dtblDatos = m_sqlDtAccGandi.ObtenerDataTable("P_NM_Planta", objParametros)
