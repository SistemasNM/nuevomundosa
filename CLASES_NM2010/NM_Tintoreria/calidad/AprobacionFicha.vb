...
#Region " Definición de Métodos "
    ...
    Public Function TransfiereFicha(ByVal strCodigoFicha As String, ByVal strUsuario As String) As DataTable
      Try
        Dim objParametros As Object() = {"strCodigoFichaPartida", strCodigoFicha, _
                                         "strUsuario", strUsuario}

        m_strError = ""

        Return m_sqlDtAccTintoreria.ObtenerDataTable("SP_VALIDA_TRANSFERENCIA_REVFIN", objParametros)
      Catch ex As Exception
