...
#Region " Definición de Métodos "
        ...
        Public Function Insertar_V2(ByVal codigoFicha As String, _
                    ...
                    ByVal pstrAccion As String, ByVal pstrID_TIPO_TELA As String) As String
            ...
            Dim parametros As Object() = {"codigoFicha", codigoFicha, _
                                          ...
                                          "kgFUrdimbreCrudo", urdimbreCrudoKgF, _
                                          "kgFTramaCrudo", tramaCrudoKgF, _
                                          "resTraccionUrdimbre_KgF", IIf(resTraccionUrdimbreKgF = "", DBNull.Value, resTraccionUrdimbreKgF), _
                                          "resTraccionUrdimbre_LbF", IIf(resTraccionUrdimbreLbF = "", DBNull.Value, resTraccionUrdimbreLbF), _
                                          "resistencia_traccion_trama_KgF", IIf(resTraccionTramaKgF = "", DBNull.Value, resTraccionTramaKgF), _
                                          "resistencia_traccion_trama_LbF", IIf(resTraccionTramaLbF = "", DBNull.Value, resTraccionTramaLbF), _
                                          "resitencia_rasgo_urdimbre_KgF", IIf(resRasgoUrdimbreKgF = "", DBNull.Value, resRasgoUrdimbreKgF), _
                                          "resitencia_rasgo_urdimbre_LbF", IIf(resRasgoUrdimbreLbF = "", DBNull.Value, resRasgoUrdimbreLbF), _
                                          "resitencia_rasgo_trama_KgF", IIf(resRasgoTramaKgF = "", DBNull.Value, resRasgoTramaKgF), _
                                          "resitencia_rasgo_trama_LbF", IIf(resRasgoTramaLbF = "", DBNull.Value, resRasgoTramaLbF), _
                                          "resitencia_Piling_Urdimbre", IIf(ResPilingUrdimbre = "", DBNull.Value, ResPilingUrdimbre), _
                                          "resitencia_piling_trama", IIf(resPilingTrama = "", DBNull.Value, resPilingTrama), _
                                          "deslizamiento_hilo_urdimbre", IIf(desHiloUrdimbre = "", DBNull.Value, desHiloUrdimbre), _
                                          "deslizamiento_hilo_trama", IIf(desHiloTrama = "", DBNull.Value, desHiloTrama), _
                                          "deslizamiento_costura_urdimbre", IIf(desCosturaUrdimbre = "", DBNull.Value, desCosturaUrdimbre), _
                                          "deslizamiento_costura_trama", IIf(desCosturaTrama = "", DBNull.Value, desCosturaTrama), _
                                          "cantidad_hilo_urdimbre", IIf(qtyHiloUrdimbre = "", DBNull.Value, qtyHiloUrdimbre), _
                                          "cantidad_hilo_trama", IIf(qtyHiloTrama = "", DBNull.Value, qtyHiloTrama), _
                                          "cantidad_costura_urdimbre", IIf(qtyCosturaUrdimbre = "", DBNull.Value, qtyCosturaUrdimbre), _
                                          "cantidad_costura_trama", IIf(qtyCosturaTrama = "", DBNull.Value, qtyCosturaTrama), _
                                          "diagnostico", IIf(diagnostico = "", DBNull.Value, diagnostico), _
                                          "usuario", usuario, _
                                          "aprobacion", aprobacion, _
                                          "numeroPrueba", pintNumeroPrueba, _
                                          "Accion", pstrAccion, "ID_TIPO_TELA", pstrID_TIPO_TELA}
            Try
                Return CType(m_sqlDtAccCalidadTintoreria.ObtenerValor("usp_CAL_Resistencia_Proceso", parametros), String)
        ...
        Public Overloads Function ObtenerUltimaPrueba(ByVal numeroFicha As String, ByVal pstrNum_Prueba As String) As DataTable
            Dim dtPrueba As DataTable
            Dim parametros() As Object = {"numeroFicha", numeroFicha, "Numero_Prueba", pstrNum_Prueba}
            Try
                dtPrueba = m_sqlDtAccCalidadTintoreria.ObtenerDataTable("usp_CAL_Resistencia_Obtener", parametros)
            Catch ex As Exception
                Throw ex
            End Try
            Return dtPrueba
...
#Region "Obtener Tipo de Tela"
        Public Function ObtenerTipoTela(ByVal pstrCodigoTabla As String) As DataTable
