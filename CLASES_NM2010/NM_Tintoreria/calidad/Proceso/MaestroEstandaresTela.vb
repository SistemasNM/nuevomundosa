...
#Region "Obtener Valores para el Dropdownlist"
        Public Function ObtenerListaDropdownList(ByVal pstr_accion As String) As DataTable
            'Obtener valores para Descripcion de acabado con la accion=1
            'Obtener valores para Descripcion de acabado con la accion=2
            Dim dtPrueba As DataTable
            Dim parametros() As Object = {"prmAccion", pstr_accion}
            Try
                dtPrueba = m_sqlDtAccCalidadTintoreria.ObtenerDataTable("usp_CAL_AcabadoyColorante_Obtener", parametros)
            Catch ex As Exception
                Throw ex
            End Try
            Return dtPrueba
...
#Region "Existe Valor de Exclusion"
        Public Function ObtenerPruebaStandares(ByVal prmCodigoTabla As String, _
        ByVal prmCodigoColumna As String, ByVal prmCodigoOperacion As String) As String
            Dim strExiste As String
            Dim parametros() As Object = {"prmCodigoTabla", prmCodigoTabla, "prmCodigoColumna", prmCodigoColumna, "prmCodigoOperacion", prmCodigoOperacion}
            Try
                strExiste = CStr(m_sqlDtAccCalidadTintoreria.ObtenerValor("usp_CAL_EXCLUSION_PRUEBAS", parametros))
