...
#Region " Definición de Métodos "
        ...
        Public Function Insertar_V2(ByVal codigoFicha As String, _
                           ...
                           ByVal pesoCrudo_grm2 As String, _
                           ByVal pesoCrudo_ozyd2 As String, _
                           ByVal pesoAcabado_grm2 As String, _
                           ByVal pesoAcabado_ozyd2 As String, _
                           ByVal pesoLavado_grm2 As String, _
                           ByVal pesoLavado_ozyd2 As String, _
                           ByVal usuario As String, _
                           ByVal strMaquinaProcedencia As String, _
                           ByVal strSecuenciaLab As String, _
                           ByVal strSecuenciaOperacion As String, _
                           ByVal strCodigoMaquina As String, ByVal aprobacion As String, ByVal pstrNumeroPrueba As Integer, ByVal pstrAccion As String) As String

            Dim parametros As Object() = {"codigoFicha", codigoFicha, _
                                          "codigoTelar", codigoTelar, _
                                          "pesoCrudo_grm2", IIf(pesoCrudo_grm2 = "", DBNull.Value, pesoCrudo_grm2), _
                                          "pesoCrudo_ozyd2", IIf(pesoCrudo_ozyd2 = "", DBNull.Value, pesoCrudo_ozyd2), _
                                          "pesoAcabado_grm2", IIf(pesoAcabado_grm2 = "", DBNull.Value, pesoAcabado_grm2), _
                                          "pesoAcabado_ozyd2", IIf(pesoAcabado_ozyd2 = "", DBNull.Value, pesoAcabado_ozyd2), _
                                          "pesoLavado_grm2", IIf(pesoLavado_grm2 = "", DBNull.Value, pesoLavado_grm2), _
                                          "pesoLavado_ozyd2", IIf(pesoLavado_ozyd2 = "", DBNull.Value, pesoLavado_ozyd2), _
                                          "usuario", usuario, _
                                          ...
                                          "CODIGO_MAQUINA_LABORATORIO", strCodigoMaquina, "aprobacion", aprobacion, "numero_prueba", pstrNumeroPrueba, "Accion", pstrAccion}
            Try
                Return CType(m_sqlDtAccCalidadTintoreria.ObtenerValor("usp_CAL_Gramaje_Proceso", parametros), String)
        ...
        Public Overloads Function ObtenerUltimaPrueba(ByVal pstrNumeroFicha As String, ByVal pstrNumeroPrueba As String) As DataTable
            ...
            Try
                dtPrueba = m_sqlDtAccCalidadTintoreria.ObtenerDataTable("usp_CAL_Gramaje_Obtener", parametros)
            Catch ex As Exception
                Throw ex
            End Try
            Return dtPrueba
