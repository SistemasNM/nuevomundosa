...
'Fecha     :      19-10-2011
'Proposito :      GIF de Engomado
'------------------------------------------

Public Class clsTejGIFEngomado
#Region "-- Variables --"
...
#End Region
    ...
    Public Function fncImportarGIFEngomado() As Boolean
        ...
        Try
            ...
            Conexion.EjecutarComando("usp_costej_DistEngomadoGIF_Procesar", objParametro)
            blnRpta = True
