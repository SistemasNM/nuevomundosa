...
Public Class clsRingAvanceInventario
...
#End Region
    ...
    'Fecha     :      14-06-2010
    'Proposito :      Definir los metodos para el % de avance de inventario de linea anillos
    '*******************************************************************************************
    ...
    Public Function ListarDatos(ByRef pDT As DataSet) As Boolean
        ...
        Try
            ...
            pDT = Conexion.ObtenerDataSet("usp_cos_ringinvavance_listar", objParametro)
    ...
    Public Function LimpiarDatos() As Boolean
        ...
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.06.14
        'Proposito :      limpia los datos, codigo 19 en utb_Datosproduccion (cabecera)
        '*******************************************************************************************
    ...
    Public Function CerrarDatos() As Boolean
        ...
        'Creado por:	  Edwin Poma
        'Fecha     :      14-06-2010
        'Proposito :      Cierra el mes, codigo 19 en utb_Datosproduccion (cabecera)
        '*******************************************************************************************
    ...
    Public Function AbrirDatos() As Boolean
        ...
        'Creado por:	  Edwin Poma
        'Fecha     :      14-06-2010
        'Proposito :      Abrir el mes, codigo 19 en utb_Datosproduccion (cabecera) 
        '*******************************************************************************************
    ...
    Public Function GuardarDatos(ByVal pdtDetalle As DataTable) As Boolean
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_ringinvavance_guardar", objParametro)
    ...
    Public Function ObtenerEsquemas(ByRef pdtDetalle As DataTable) As Boolean
        ...
        blnRpta = lclsEsquemas.ObtenerEsquemas(pDT, clsEsquemas.enu_esquemas.GuardarAvanceInvRing)
