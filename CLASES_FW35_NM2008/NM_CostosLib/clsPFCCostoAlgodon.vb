...
Public Class clsPFCCostoAlgodon
...
#Region "-- Metodos --"
    ...
    Public Function Listar(ByRef pDT As DataSet) As Boolean
        ...
        Try
            ...
            pDT = Conexion.ObtenerDataSet("usp_cos_costoalgodon_listar ", objParametro)
    ...
    Public Function ObtenerEsquemas(ByRef pdtData As DataTable) As Boolean
        ...
        blnRpta = lclsEsquemas.ObtenerEsquemas(pDT, clsEsquemas.enu_esquemas.PFCCostoAlgodon)
    ...
    Public Function Guardar(ByVal pdtData As DataTable) As Boolean
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_costoalgodon_guardar", objParametro)
    ...
    Public Function Importar() As Boolean
        ...
        'Creado por:	  EPM
        'Fecha     :      06-12-2010
        'Proposito :      importar los datos de stock, resumen de materia prima
        '*******************************************************************************************
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_costoalgodon_importar", objParametro)
        Catch ex As Exception
            blnRpta = False
            mstrError = ex.Message
        Finally
