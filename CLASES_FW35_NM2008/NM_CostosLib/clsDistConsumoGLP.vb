...
Public Class clsDistConsumoGLP
...
#End Region
    ...
    'Fecha     :      2010.01.16
    'Proposito :      Definir los metodos para el cálculo y distribucion del consumo de GLP
    '*******************************************************************************************
    ...
    Public Function ListarDatosxPeriodo(ByRef pDT As DataSet) As Boolean
        ...
        'Creado por:	  Edwin Poma
        'Fecha     :      2009.12.21
        'Proposito :      retorna 2 consultas del calculo de consumo de glp lista de cabecera, lista de detalle
        '*******************************************************************************************
        ...
        Try
            ...
            pDT = Conexion.ObtenerDataSet("usp_cos_unidadconsumodistglpxperiodo_listar", objParametro)
    ...
    Public Function DistribuirConsumoOfisis() As Boolean
        ...
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.05.24
        'Proposito :      Procesa los porcentajes de distribución a ofisis, genera un vale de salida
        'con los datos guardados en frm_subirlogistica
        '*******************************************************************************************

        Dim blnRpta As Boolean, ldtbDocumento As DataTable
        Dim Conexion As AccesoDatosSQLServer
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            ldtbDocumento = Conexion.ObtenerDataTable("usp_cos_GeneraDocLogistica", objParametro)
            If (Not ldtbDocumento Is Nothing) AndAlso ldtbDocumento.Rows.Count > 0 Then
                mstrNumeroDocumento = ldtbDocumento.Rows(0).Item("vch_NumeroDocumento").ToString
            Else 'Error
                mstrNumeroDocumento = ""
            End If
        Catch ex As Exception
    ...
    Public Function ProcesarDistribucionGLP() As Boolean
        '*******************************************************************************************
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.01.22
    ...
    Public Function LimpiarDistribucionGLP() As Boolean
        '*******************************************************************************************
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.01.22
        'Proposito :      Agrupa en C.C. los consumos de EE
    ...
    Public Function ListarDistribucionGLPxPeriodo(ByRef pDT As DataSet) As Boolean
        '*******************************************************************************************
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.01.11
    ...
    Public Function ListarDistribucionGLPxHistorico(ByRef pDT As DataTable) As Boolean
        '*******************************************************************************************
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.01.11
    ...
    Public Function ObtenerEsquemas(ByRef pdtDetalle As DataTable) As Boolean
        ...
        blnRpta = lclsEsquemas.ObtenerEsquemas(pDT, clsEsquemas.enu_esquemas.DistConsumoGLP)
    ...
    Public Function CalcularConsumo(ByVal pdtDetalle As DataTable) As Boolean
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_unidadconsumodistglpxperiodo_guardar", objParametro)
        Catch ex As Exception
            blnRpta = False
            mstrError = ex.Message
        Finally
    ...
    Public Function CerrarConsumo() As Boolean
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_unidadconsumodistglpxperiodo_cerrar", objParametro)
        Catch ex As Exception
            blnRpta = False
            mstrError = ex.Message
        Finally
    ...
    Public Function AbrirConsumo() As Boolean
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_unidadconsumodistglpxperiodo_abrir", objParametro)
        Catch ex As Exception
            blnRpta = False
            mstrError = ex.Message
        Finally
    ...
    Public Function LimpiarConsumo() As Boolean
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_unidadconsumodistglpxperiodo_limpiar", objParametro)
        Catch ex As Exception
            blnRpta = False
            mstrError = ex.Message
        Finally
