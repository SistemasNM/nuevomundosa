...
#End Region
    ...
    'Fecha     :      27-11-2009
    'Proposito :      Definir los metodos para el cálculo y distribucion del consumo de EE de planta principal y planta hilandería
    '*******************************************************************************************

    '======== Metodos de Consulta ========

    Public Function ProcesarDistribucionEE() As Boolean
        '*******************************************************************************************
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.01.22
    ...
    Public Function LimpiarDistribucionEE() As Boolean
        '*******************************************************************************************
        'Creado por:	  Edwin Poma
        'Fecha     :      2010.01.22
        'Proposito :      Agrupa en C.C. los consumos de EE
    ...
    Public Function ListarDistribucionEExPeriodo(ByRef pDT As DataSet) As Boolean
        '*******************************************************************************************
        'Creado por:	  Edwin Poma
        'Fecha     :      2009.12.10
