...
#End Region
    ...
    Function setearParametros(ByVal ObjclsAnalisisTela As clsAnalisisTela) As Object
        Dim objParametros() As Object = {"p_vch_accion", ObjclsAnalisisTela.Accion, _
                                         "p_vch_id_requer", ObjclsAnalisisTela.IdRequer, _
                                         "p_vch_referencia", ObjclsAnalisisTela.Referencia, _
                                         "p_vch_solicitante", ObjclsAnalisisTela.Solicitante, _
                                         "p_vch_id_estado", ObjclsAnalisisTela.IdEstado, _
                                         "p_vch_observacion1", ObjclsAnalisisTela.Observacion1, _
                                         "p_vch_descrip_tec", ObjclsAnalisisTela.DescripcionTecnica, _
                                         "p_vch_ligamento", ObjclsAnalisisTela.Ligamento, _
                                         "p_num_peso", ObjclsAnalisisTela.Peso, _
                                         "p_num_onza", ObjclsAnalisisTela.Onza, _
                                         "p_num_ancho", ObjclsAnalisisTela.Ancho, _
                                         "p_vch_tit_urd", ObjclsAnalisisTela.TitUrd, _
                                         "p_vch_tit_trama", ObjclsAnalisisTela.TitTrama, _
                                         "p_vch_mat_urd", ObjclsAnalisisTela.MatUrd, _
                                         "p_vch_mat_trama", ObjclsAnalisisTela.MatTrama, _
                                         "p_int_hilos", ObjclsAnalisisTela.Hilos, _
                                         "p_int_pasadas", ObjclsAnalisisTela.Pasadas, _
                                         "p_vch_color", ObjclsAnalisisTela.Color, _
                                         "p_vch_elongacion", ObjclsAnalisisTela.Elongacion, _
                                         "p_num_costo_ref", ObjclsAnalisisTela.CostoRef, _
                                         "p_vch_observacion2", ObjclsAnalisisTela.Observacion2, _
                                         "p_vch_ruta_muestra_tela", ObjclsAnalisisTela.URLMuestraTela, _
                                         "p_vch_usuario", ObjclsAnalisisTela.Usuario, _
                                         "p_vch_mca1", ObjclsAnalisisTela.Mca1, _
                                         "p_vch_mca2", ObjclsAnalisisTela.Mca2, _
                                         "p_vch_mca3", ObjclsAnalisisTela.Mca3, _
                                         "p_vch_fecdesde", ObjclsAnalisisTela.FecDesde, _
                                         "p_vch_fechasta", ObjclsAnalisisTela.FecHasta, _
    ...
    Function CRUDRequerimientos(ByVal ObjclsAnalisisTela As clsAnalisisTela) As DataTable
        Try
            Dim objParametros() As Object = setearParametros(ObjclsAnalisisTela)
