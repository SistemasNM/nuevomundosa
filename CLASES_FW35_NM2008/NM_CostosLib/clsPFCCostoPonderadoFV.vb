...
Public Class clsPFCCostoPonderadoFV
...
#Region "-- Metodos --"
    ...
    Public Function Listar(ByRef pDT As DataSet) As Boolean
        ...
        'Creado por:	  EPM
        'Fecha     :      04-01-2011
        'Proposito :      retorna un listado costos FV
        '*******************************************************************************************
        ...
        Try
            ...
            pDT = Conexion.ObtenerDataSet("usp_cos_costoponderado_listar ", objParametro)
    ...
    Public Function ObtenerEsquemas(ByRef pdtData As DataTable) As Boolean
        ...
        blnRpta = lclsEsquemas.ObtenerEsquemas(pDT, clsEsquemas.enu_esquemas.PFCCostoPonderadoFV)
    ...
    Public Function Guardar(ByVal pdtData As DataTable) As Boolean
        ...
        'Creado por:	  EPM
        'Fecha     :      04-01-2011
        'Proposito :      Actualiza la informacion de los costos FV
        '*******************************************************************************************

        Dim blnRpta As Boolean, clsUtilitario As New ComunLib.clsUtil
        Dim Conexion As AccesoDatosSQLServer

        pdtData.TableName = "listadet"
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_costoponderado_guardar", objParametro)
    ...
    Public Function Agregar() As Boolean
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_costoponderado_insertar", objParametro)
    ...
    Public Function Importar() As Boolean
        ...
        'Creado por:	  EPM
        'Fecha     :      04-01-2011
        'Proposito :      importa los costos FV (promedio de los ult 4 meses)
        '*******************************************************************************************
        ...
        Try
            ...
            blnRpta = True
            Conexion = New AccesoDatosSQLServer(GeneradorCadenaConexion.enmBasesDatos.CostosReales)
            Conexion.EjecutarComando("usp_cos_costoponderado_importar", objParametro)
