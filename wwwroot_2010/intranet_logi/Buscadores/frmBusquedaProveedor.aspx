<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmBusquedaProveedor.aspx.vb" Inherits="intranet_logi.frmBusquedaProveedor" %>
			...
			<table width="440px" border="0" cellspacing="2" cellpadding="1">
				<tr>
					<td class="Cabecera" style = "text-align:center">
                        <asp:Label ID="lblTitulo" runat="server" Text="Búsqueda de Proveedor"></asp:Label>
                    </td>
				</tr>
				<tr>
					<td>
