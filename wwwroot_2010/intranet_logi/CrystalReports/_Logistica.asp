...
Select Case request.QueryString("strFormulario")
	Case "LOG30007"
		reportname = "../Rpts/Proveedores.rpt"
	Case "LOG20006"
		reportname = "../Rpts/OrdenCompra.rpt"
End Select
...
Dim lstrEmpresa , lstrRetencion , lstrBuenContribuyente
Dim lstrOC

Select Case request.QueryString("strFormulario")
	Case "LOG30007"
		lstrEmpresa = request.QueryString("strEmpresa")
		lstrRetencion = request.QueryString("strRetenedor")
		lstrBuenContribuyente = request.QueryString("strBuenContribuyente")

		Params.Item(1).SetCurrentValue (lstrEmpresa)
		Params.Item(2).SetCurrentValue (lstrRetencion)
		Params.Item(3).SetCurrentValue (lstrBuenContribuyente)
	Case "LOG20006"
		lstrOC = request.QueryString("strOC")
		
		Params.Item(1).SetCurrentValue (lstrOC)
End Select
