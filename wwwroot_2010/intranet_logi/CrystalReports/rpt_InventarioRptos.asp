...
Dim lstrEmpresa
Dim lstrUbicacion
lstrEmpresa = Request("Var_Empresa")
lstrUbicacion = Request("Var_Ubicacion")
response.Write lstrEmpresa
response.Write lstrUbicacion
reportname = "../Rpts/Rpt_Inventario_Rptos.rpt"
...
Params.Item(2).SetCurrentValue (lstrUbicacion)
