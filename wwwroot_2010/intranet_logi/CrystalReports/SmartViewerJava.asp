...
<html>
<head>
<title>Crystal Reports Java Viewer using Browser's JVM</title>
</head>
...
<SCRIPT LANGUAGE="JavaScript"><!--
 	...
 	//--></SCRIPT></COMMENT>
 		<SCRIPT LANGUAGE="JavaScript"><!--
 			if(_ns3==true)
 			document.writeln( '<applet code=com.crystaldecisions.ReportViewer.ReportViewer codebase="/viewer/JavaViewer" id=ReportViewer width=100% height=100%  archive="/viewer/JavaViewer/ReportViewer.zip">' );
 			else if (_ns4 == true)
			document.writeln( '<applet code=com.crystaldecisions.ReportViewer.ReportViewer codebase="/viewer/JavaViewer" id=ReportViewer width=100% height=100%  archive="/viewer/JavaViewer/ReportViewer.jar">' );
  			else
			document.writeln( '<applet code=com.crystaldecisions.ReportViewer.ReportViewer codebase="/viewer/JavaViewer" id=ReportViewer width=100% height=100%  >' );
 		//--></SCRIPT>
