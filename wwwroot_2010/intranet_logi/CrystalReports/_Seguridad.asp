...
'strServidor = CSTR(objConexion.GetServidor("OFISEGU"))
'strBaseDatos = CSTR(objConexion.GetBaseDatos("OFISEGU"))
'strUsuario = CSTR(objConexion.GetUsuario("OFISEGU"))
'strPassword = CSTR(objConexion.GetPassword("OFISEGU"))

    strServidor =  "Servbd02\nmundo02"
	strBaseDatos = "OFISEGU"
	strUsuario =   "ENLACE08"
	strPassword =  "ENLACE08"
    ''CAMBIO JRUIZ -ACTUALIZAR VARIABLES - 20211126 FIN

reportname = "../Rpts/Requisicion.rpt"
...
Dim lstrEmpresa , lstrRequisicion , lstrUsuario

lstrEmpresa = request.QueryString("strEmpresa")
lstrRequisicion = request.QueryString("strRequisicion")
lstrUsuario = request.QueryString("strUsuario")

Params.Item(1).SetCurrentValue (lstrEmpresa)
Params.Item(2).SetCurrentValue (lstrRequisicion)
Params.Item(3).SetCurrentValue (lstrUsuario)

'response.write strempresa + " " + strfecha
