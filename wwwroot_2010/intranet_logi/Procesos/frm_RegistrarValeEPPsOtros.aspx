<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RegistrarValeEPPsOtros.aspx.vb" Inherits="intranet_logi.frm_RegistrarValeEPPsOtros" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head id="Head1" runat="server">
  ...
  <link href="../css/sytle.css" type="text/css" rel="stylesheet"/>
     <%--<script language="javascript" src="../../intranet/JS/jsCalendario_N4.js" type="text/javascript"></script>--%><%--  <script src="../js/jsCalendario_N4.js" type="text/javascript"></script>--%>
  ...
  <script language="javascript" type="text/javascript">
      ...
      function fnc_ConfirmarAproba(strNumPedido) {
          if (confirm("Esta Seguro de Aprobar los Articulos Agregados al pedido " + strNumPedido) == true) {
              return true;
          } else { return false; }
      }
      // Validacion de datos
      function fnc_VerificarDatos() {
          ...
          if (document.getElementById('txtCodCuentaGastos').value == "") {
...
//          }
          ...
          // Orden Trabajo
//          if (document.getElementById('txtCodOrdenTrabajo').value == "") {
...
//              return false;
          ...
          var ldtbResultado = frm_RegistrarValeEPPsOtros.ValidarCuentaGastoOT(varCtGasto);
...
//          }
      ...
      function VerConsultaPedido() {
          var retorno = window.showModalDialog("frm_ConsultaPedidoEPPsOtros.aspx", "", "dialogHeight:600px;dialogWidth:800px;center:yes;help:no;");
          if (retorno == "") {
              return false;
          }
          if (retorno != "" && retorno != ":") {
      ...
      function fnc_BuscarCtaGasto() {
          ...
          if (strCentroCostos == "") {
              ...
              if (retorno != "" && retorno != ":") {
                  ...
                  //CONNTROL DE GESTION - DG  -INI
                  var resul = frm_RegistrarValeEPPsOtros.ValidarCuentaGastoOT(Codigo)
                  if (resul.value == "") {
 ...
 <body>
  <form id="frm_RegistrarValeAlmacen" method="post" autocomplete="off" runat="server">
   <center>
    ...
    <ContentTemplate>--%>	   <%--Titulo--%>
	   <table style="width:800px" cellspacing="0" cellpadding="0" border="0">
	    <tr>
	     <td class="Cabecera" style="width: 800px; height: 30px" align="center">Vales de EPP's y Otros</td>
	    </tr>
	   </table>
     ...
     <%--Inicio: Parametros Generales--%>
      <table style="width: 840px">
       ...
       <tr>
         ...
         <asp:dropdownlist id="cboTipo" runat="server" CssClass="cboFormulario" 
                  Font-Size="9px" width="140px" Height="16px">
           <asp:ListItem Value="0">Seleccionar</asp:ListItem>
            <asp:ListItem Value="1">EPP&#39;s</asp:ListItem>
	        <asp:ListItem Value="2">Uniformes(masivo)</asp:ListItem>
             <asp:ListItem Value="3">Utiles de Áseo(masivo)</asp:ListItem>
             <asp:ListItem Value="4">Canasta Navideña(masivo)</asp:ListItem>
             <asp:ListItem Value="5">Regalo de Cumpleaños</asp:ListItem>
             <asp:ListItem Value="6">Regalo de Aniversario</asp:ListItem>
             <asp:ListItem Value="7">EPPs Protección(masivo)</asp:ListItem>
             <asp:ListItem Value="8">Bolsa de Aseo(masivo)</asp:ListItem>
             <asp:ListItem Value="9">Mat. de desinfección(masivo) </asp:ListItem>
             <asp:ListItem Value="10">Uniformes</asp:ListItem>
         </asp:dropdownlist>
        </td>
       ...
       <%--<tr>
	      ...
	      <td align="left" class="style1">              
              <asp:TextBox ID="txtFecInstal" runat="server" class="input" style="width: 98px"></asp:TextBox>
              <img onclick="popUpCalendar(this, frm_RegistrarValeAlmacen.txtFecInstal, 'dd/mm/yyyy')" height="16" width="16" alt="Seleccionar fecha" src="../../intranet/Imagenes/Calendario.gif" border="0" />
          </td>
...
<%--       <tr>
      ...
      <%--Inicio: datos Articulo--%>
	    <table style="width: 830px"> 
         ...
         <asp:panel id="pnlArticulo" runat="server" width="830px">
          ...
          <table style="width: 830px">
           <%--titulo de cabecera--%>
		       <tr>
                ...
                <td class="Descripcion" style="width:200px" align="left">Orden Trabajo:/Monto:</td>
           ...
           <tr>
            ...
            <td class="Descripcion" style="width: 200px">
		         <asp:textbox id="txtCodOrdenTrabajo" runat="server" Font-Size="9px" width="80px" MaxLength="20" CssClass="txtHabilitado"></asp:textbox>
             ...
             &nbsp;<asp:TextBox ID="txtMonto" runat="server" BorderStyle="None" Cssclass="Descripcion" Font-Size="8px" width="70px"></asp:TextBox>
            </td>
		        <%--<td class="Descripcion" style="width: 200px">
           ...
           <%--descripcion de cabecera--%>
             ...
             <asp:textbox id="lblStockArticulo" BorderStyle="None" runat="server" Cssclass="Descripcion" width="60px" Font-Size="8px"></asp:textbox>
                ...
                <td class="Descripcion" style="width:200px">
                    <asp:TextBox ID="lblDesOrdenTrabajo" runat="server" BorderStyle="None" Cssclass="Descripcion" Font-Size="8px" width="200px"></asp:TextBox>
                </td>
		        <td class="Descripcion" style="width:200px">
    ...
    <%--Codigo--%>   
     ...
     <table style="WIDTH:800px" cellspacing="0" cellpadding="0" border="0">
       ...
       <td style="width:120px" align="right">
        <asp:Button id="btnAceptar" runat="server" CssClass="btnAzul" Text="Aceptar"/>
       </td>
       <%--<td style="WIDTH:120px" align="right">
