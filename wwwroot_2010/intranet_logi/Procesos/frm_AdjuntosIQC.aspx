<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_AdjuntosIQC.aspx.vb" Inherits="intranet_logi.frm_AdjuntosIQC" %>
...
<body>
 <form id="frm_AdjuntosIQC" runat="server">
  <center>
   ...
   <asp:Panel ID="pnlCargaFile" runat="server" CssClass="pnlModal" Width="600px">
    <table style="WIDTH: 600px; height:40px" cellspacing="0" border="0" cellpadding = "0">
     ...
     <tr>
      ...
      <tr>
	  <td class="Etiqueta" style="WIDTH: 400px" valign="middle" align = "left">
       <asp:textbox id="Textbox1" runat="server" Width="380px" CssClass="input" MaxLength="50" Font-Size = "10px"></asp:textbox>
      </td>
      <td class="Etiqueta" style="WIDTH: 200px" valign="middle" align = "left">
