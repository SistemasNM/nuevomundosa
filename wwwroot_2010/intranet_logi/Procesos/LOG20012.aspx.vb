    ...
    Private Sub DataGrid1_ItemDataBound(ByVal sender As System.Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        Select Case e.Item.ItemType
            ...
            Case ListItemType.AlternatingItem, ListItemType.Item
                ...
                btnprint.Attributes.Add("onClick", "javascript:return ImprimirCodBar('" & ldrvItem("vch_codarticulo").ToString & "','" & ldrvItem("de_item").ToString.Replace("'", "") & "','" & ldrvItem("vch_codigobarra1").ToString & "','" & ldrvItem("vch_codigobarra2").ToString & "','" & ldrvItem("vch_codigobarra3").ToString & "','" & ldrvItem("vch_codigobarra4").ToString & "','" & ldrvItem("co_ubic_rece").ToString & "');")
