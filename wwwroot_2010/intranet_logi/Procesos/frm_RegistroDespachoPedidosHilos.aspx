<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RegistroDespachoPedidosHilos.aspx.vb" Inherits="intranet_logi.frm_RegistroDespachoPedidosHilos" %>
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager> 
    ...
    <%--titulo--%>
		<table id="tblCabeceraPagina" border="0" cellspacing="0" cellpadding="0" width="800px">
		 <tr>
			<td style="width:800px; height:30px" class="Cabecera">DESPACHO DE PEDIDO DE HILOS</td>
		 </tr>
		</table>
     ...
     <ContentTemplate>
      ...
      <%--grilla--%>
         ...
         <asp:datagrid id="dgDetalle" runat="server" width="800px" AutoGenerateColumns="False">
           ...
           <asp:TemplateColumn HeaderText="Stock Con.">
						<HeaderStyle width="50px" HorizontalAlign="Center"></HeaderStyle>
						<ItemStyle Font-Size="8px" HorizontalAlign="Right" width="50px"></ItemStyle>
						<ItemTemplate>
						 <asp:Label id="lblStockKgs" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Stock_alte") %>'></asp:Label>
						</ItemTemplate>
					 </asp:TemplateColumn>

					 <asp:TemplateColumn HeaderText="Conos">
						<HeaderStyle width="50px" HorizontalAlign="Center"></HeaderStyle>
						<ItemStyle Font-Size="8px" HorizontalAlign="Right" width="50px"></ItemStyle>
						<ItemTemplate>
						 <asp:TextBox ID="txtDespachable" runat="server" width="50px" Font-Bold="true" Font-Size="8px" CssClass="inputDerecha" Text='<%# DataBinder.Eval(Container, "DataItem.CA_DESP") %>'></asp:TextBox>
						</ItemTemplate>
					 </asp:TemplateColumn>
           ...
           <asp:TemplateColumn HeaderText="Kgs.">
						...
						<ItemStyle Font-Size="8px" HorizontalAlign="Right" width="50px"></ItemStyle>
						<ItemTemplate>
						 <asp:TextBox ID="txtDespachableKgs" runat="server" width="50px" Font-Bold="true" Font-Size="8px" CssClass="inputDerecha" Text='<%# DataBinder.Eval(Container, "DataItem.ca_desp_alte") %>'></asp:TextBox>
						</ItemTemplate>
					 </asp:TemplateColumn>
					</Columns>
				 </asp:datagrid>
