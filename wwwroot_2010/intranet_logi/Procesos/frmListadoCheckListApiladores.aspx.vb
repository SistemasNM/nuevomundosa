...
Public Class frmListadoCheckListApiladores
...
#Region "Funciones"
    ...
    Private Sub filtrarListadoCheckList()
        ...
        ldtResponse = objPedido.fncCheckListApiladoresCRUD(lvchAccion, lvchCodEmpl, lIntTurno, lvchFechaChk,
                                                           lvchNumMaquina, lvchHorometroE, lvchHorometroS, lvchMcaFlag1,
                                                           lvchMcaFlag2, lvchMcaFlag3, lvchMcaFlag4, lvchMcaFlag5,
                                                           lvchMcaFlag6, lvchMcaFlag7, lvchMcaFlag8, lvchMcaFlag9,
                                                           lvchMcaFlag10, lvchMcaFlag11, lvchMcaFlag12, lvchMcaFlag13,
                                                           lvchObservaciones1, lvchObservaciones2, lvchObservaciones3, lvchUsuario)
...
#End Region
    ...
    Protected Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        ...
        Response.Redirect("frm_CheckListApiladores.aspx?Accion=INSERT")
    ...
    Protected Sub dgListaCheckList_ItemCommand(source As Object, e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgListaCheckList.ItemCommand
        Select Case e.CommandName
            Case "Editar"
                ...
                Response.Redirect("frm_CheckListApiladores.aspx?Accion=UPDATE&idChk=" + e.CommandArgument)
