<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RegistrarOrdenServicio.aspx.vb" Inherits="intranet_logi.frm_RegistrarOrdenServicio" %>
 ...
 <%-- <script language="javascript" type="text/javascript" src="../../intranet/JS/functions.js"></script>--%>
  ...
  <script language="JavaScript" type="text/javascript">
      ...
      function txtCodigoCentroCosto_onBlur(ControlID, Constante) {
          var Codigo = document.all[ControlID + "_txtCodigoCentroCosto_S_" + Constante];
          var Nombre = document.all("HDN1");
           ...
           if (strTipoBusqueda != "CuentaGastos" || (strTipoBusqueda == "CuentaGastos" && strCentroCostos != "")){
               ...
               if (retorno != "" && retorno != ":") {
                   ...
                   switch (strTipoBusqueda) {
                       case "CuentaGastos":                                                          
                           document.getElementById(ControlID + "_txtCodigoCuentaGastos_S_" + Constante).value = codigo;
                       ...
                       case "CentrodeCostos":
                           if (document.getElementById('txtTipoReq').value == 'ART') {
                               document.getElementById(ControlID + "_txtCodigoCentroCosto" + Constante).value = codigo;
                           }
                           else {
                               document.getElementById(ControlID + "_txtCodigoCentroCosto_S_" + Constante).value = codigo;
                           }
...
//          }
          ...
          var ldtbResultado = frm_RegistrarOrdenServicio.fnc_ValidarCodigos(document.all('txtAreaSolicitanteCodigo').value, lstrCuentaGasto, '', '', '', '', '');
      ...
      function fnc_Datagrid2_Validar(ControlID, Constante) {
          ...
          var ltxtCuentaGastos = document.all(ControlID + '_txtCodigoCuentaGastos_S_' + Constante);
          ...
          var ldtbResultado = frm_RegistrarOrdenServicio.fnc_ValidarCodigos('', ltxtCuentaGastos.value, ltxtGrupo.value, ltxtTipo.value, ltxtCentroCosto.value, ltxtOrdenServicio.value, '');
          if (ldtbResultado != null && typeof (ldtbResultado) == "object") {
              var ldtbResultadoOk = ldtbResultado.value;
      ...
      function fnc_AdjuntarDocs(strSecuencia) {
          var pstrTipoDoc = "RQS"
          var pstrNumeroDoc = document.all('txtSerie').value + "-" + document.all('txtNumero').value
          var pstrSecuencia = strSecuencia
          if (document.all('txtSituacion').value == "ACTIVO") {
         ...
         <table id="Table1" cellspacing="0" cellpadding="0" border="0" class = "Cabecera" style = "width: 900px; height: 20px">
            ...
            <table cellspacing="2" cellpadding="0" width="900px" border="0">
                ...
                <tr>
                    ...
                    <td class="Etiqueta" style="WIDTH: 500px; height:20px" valign="middle" align = "left"><asp:textbox id="txtAreaSolicitanteNombre" runat="server" Width="450px" CssClass="inputDisabled2" MaxLength="10"></asp:textbox></td>
                </tr>
<%--
...
--%>
                 <tr>
                    <td class="Etiqueta" style="WIDTH: 150px; height:20px" valign="middle" align = "left">
                        Fecha Tentativa de Implementación:</td>
                    <td class="Etiqueta" style="WIDTH: 150px; height:20px" valign="middle" align = "left">
                        <asp:textbox id="txtFecIns" runat="server" Width="115px" CssClass="input"></asp:textbox>
        ...
        <table style="WIDTH: 900px">
            <tr>
                <td class="Etiqueta" style="WIDTH: 900px" valign="middle" align = "left">
                    <asp:datagrid id="DataGrid2" runat="server" Width="900px" ShowFooter="True" AutoGenerateColumns="False" Font-Bold="False">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Grpo. Servicio">
                                ...
                                <FooterTemplate>
                                    ...
                                    <tr>
                                        <td width="50px"><asp:TextBox id="txtGrupoServF" runat="server" CssClass="input" Width="35px" Font-Size="10px"></asp:TextBox></td>
                                        <td width="50px"><asp:TextBox id="txtTipoServF" runat="server" CssClass="input" Width="35px" Font-Size="10px"></asp:TextBox></td>
                                ...
                                <EditItemTemplate>
                                    ...
                                    <tr>
                                        <td width="50px"><asp:TextBox id="txtGrupoServE" runat="server" CssClass="input" Width="35px"  text='<%#Container.DataItem("CO_GRUP_SERV")%>' Font-Size="10px"></asp:TextBox></td>
                                        <td width="50px"><asp:TextBox id="txtTipoServE" runat="server" CssClass="input" Width="35px" text='<%#Container.DataItem("CO_SERV")%>' Font-Size="10px"></asp:TextBox></td>
                            ...
                            <FooterTemplate>
                                <asp:TextBox id="txtDesServicioF" runat="server" CssClass="Input" Width="270px" MaxLength="200" TextMode="MultiLine" Font-Size="10px"></asp:TextBox>
                            </FooterTemplate>
                            <EditItemTemplate>
                               <asp:TextBox id="txtDesServicioE" runat="server" CssClass="Input" Width="270px" MaxLength="200" TextMode="MultiLine" text='<%#Container.DataItem("DE_ITEM")%>' Font-Size="10px"></asp:TextBox>
                            </EditItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <FooterTemplate>
                                ...
                                <tr>
                                    <td width="90px"><asp:TextBox id="txtCodigoCentroCosto_S_F" runat="server" CssClass="input" Width="60px" Font-Size="10px"></asp:TextBox></td>
		                    ...
		                    <EditItemTemplate>
                                ...
                                <tr>
                                    <td><asp:TextBox id="txtCodigoCentroCosto_S_E" runat="server" CssClass="input" Width="60px" text='<%#Container.DataItem("CO_AUXI_EMPR")%>' Font-Size="10px"></asp:TextBox></td>
                            ...
                            <FooterTemplate>
                                ...
                                <tr>
                                    <td width="90px"><asp:TextBox id="txtCodigoCuentaGastos_S_F" runat="server" CssClass="input" Width="60px" Font-Size="10px"></asp:TextBox></td>
		                    ...
		                    <EditItemTemplate>
                                ...
                                <tr>
                                    <td><asp:TextBox id="txtCodigoCuentaGastos_S_E" runat="server" CssClass="input" Width="60px" text='<%#Container.DataItem("DE_OBSE")%>' Font-Size="10px"></asp:TextBox></td>
...
<%--                                    <td class="GridHeader" width="75px"></td>--%>
                            ...
                            <FooterTemplate>
                                ...
                                <tr>
                                    <td><asp:TextBox id="txtCodOrdenServicio_S_F" runat="server" CssClass="Input" Width="60px" Font-Size="10px"></asp:TextBox></td>
                        ...
                        <EditItemTemplate>
                            ...
                            <tr>
                                <td><asp:TextBox id="txtCodOrdenServicio_S_E" runat="server" CssClass="input" Width="60px" text='<%#Container.DataItem("CO_ORDE_SERV")%>' Font-Size="10px"></asp:TextBox></td>
		            ...
		            <FooterTemplate>
                        <asp:TextBox id="txtCantidadSF" runat="server" CssClass="inputDerecha" Width="50px" Font-Size="10px"></asp:TextBox>
                    </FooterTemplate>
		            <EditItemTemplate>
                        <asp:TextBox id="txtCantidadSE" runat="server" CssClass="inputDerecha" Width="50px" text='<%#Container.DataItem("CA_SOLI")%>' Font-Size="10px"></asp:TextBox>
                    </EditItemTemplate>
                    </asp:TemplateColumn>
