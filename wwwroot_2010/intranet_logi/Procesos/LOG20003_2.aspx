<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LOG20003_2.aspx.vb" Inherits="intranet_logi.LOG20003_2" %>
					...
					<td class="panel">
						...
						<table width="100%" border="0">
							<tr>
								...
								<td class="Etiqueta" width="85">
									<asp:Panel id="Panel3" runat="server" Width="90px">Fecha Inicio Trabajo</asp:Panel>
								</td>
								<td width="120"><asp:textbox id="txtFechaTope" runat="server" CssClass="input"></asp:textbox></td>
                                <td class="Etiqueta" width="85">
									<asp:Panel id="Panel9" runat="server" Width="90px">Fecha Fin Trabajo</asp:Panel>
								</td>
								<td width="120"><asp:textbox id="txtFechaFinTrabajo" runat="server" CssClass="input"></asp:textbox></td>									
							</tr>
                            <tr>
                                <td class="Etiqueta" width="85">
