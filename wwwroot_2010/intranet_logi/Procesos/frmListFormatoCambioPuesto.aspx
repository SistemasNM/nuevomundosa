<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmListFormatoCambioPuesto.aspx.vb" Inherits="intranet_logi.frmListFormatoCambioPuesto" %>
  ...
  <body>
	<form id="frmListaFormatoCP" method="post" runat="server" autocomplete="off">
      <table border="0" cellspacing="0" cellpadding="0" width="800px">
		<tr>
		  <td style="WIDTH:800px;height:20px" class="Cabecera">Formato Cambio de Puesto</td>
		</tr>
	  </table>
	  <table style="WIDTH:800px" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		 <td style="WIDTH:120px" class="Etiqueta">Trabajador:</td>
		 <td style="WIDTH:150px">
          <asp:textbox id="txtResponsable" runat="server" Font-Size="10px" width="100px" MaxLength="10"></asp:textbox>
          &nbsp;<input style="width:20px; height:20px" id="btnResponsable" class="boton" onclick="javascript:fnc_BuscarTrabajador();" value="..." type="button" name="btnResponsable" />
         </td>
		 <td style="WIDTH:530px" valign="middle" align="left" colspan="3">
          <asp:Label id="lblTrabajador" Runat="server" Font-Size="9px" width="421px"></asp:Label>
         </td>
		</tr>
        <tr>
		 ...
		 <td style="WIDTH:800px">
          <asp:datagrid id="gvFormatoCP" runat="server" Width="1000px" AutoGenerateColumns="False">
           ...
           <asp:TemplateColumn>
			...
			<asp:BoundColumn DataField="VCH_TRABAJADOR" HeaderText="Trabajador">
			 <HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="120px"></HeaderStyle>
			 <ItemStyle Font-Size="8px" HorizontalAlign="Left"></ItemStyle>
			</asp:BoundColumn>

			<asp:BoundColumn DataField="VCH_COD_PUESTO_A" HeaderText="Puesto Actual">
			 <HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="200px"></HeaderStyle>
			 <ItemStyle Font-Size="8px" HorizontalAlign="Left"></ItemStyle>
			</asp:BoundColumn>

			<asp:BoundColumn DataField="VCH_COD_PUESTO_N" HeaderText="Puesto Promoción">
			 <HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="200px"></HeaderStyle>
			 <ItemStyle Font-Size="8px" HorizontalAlign="Left"></ItemStyle>
			</asp:BoundColumn>

            <asp:BoundColumn DataField="FEC_INICIO" HeaderText="Fecha Inicio">
			 <HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="80px"></HeaderStyle>
			 <ItemStyle Font-Size="8px" HorizontalAlign="Left"></ItemStyle>
			</asp:BoundColumn>

            <asp:BoundColumn DataField="VCH_TIEMPO_SERV" HeaderText="Tiempo Servicio(años)">
			 <HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="90px"></HeaderStyle>
			 <ItemStyle Font-Size="8px" HorizontalAlign="Left"></ItemStyle>
			</asp:BoundColumn>
