<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RegistrarOrdenServicio_3.aspx.vb" Inherits="intranet_logi.frm_RegistrarOrdenServicio_3" %>
  ...
  <script language="JavaScript" type="text/javascript">
              ...
              if (retorno != "" && retorno != ":") {
                  ...
                  switch (strTipoBusqueda) {
                      case "CuentaGastos":
                          ...
                          var resul = frm_RegistrarOrdenServicio_3.ValidarCuentaGastoOT(codigo)
                          if (resul.value == "") {
      ...
      function fnc_BuscarOrdenTrabajo(Constante) {
          ...
          if (retorno != "" && retorno != ":") {
              ...
              var ldtbResultado = frm_RegistrarOrdenServicio_3.CargarMontoOt(Codigo);
      ...
      function fnc_ValidarRequisicion() {
          ...
          var ldtbResultado = frm_RegistrarOrdenServicio_3.fnc_ValidarCodigos(document.getElementById('txtAreaSolicitanteCodigo').value, lstrCuentaGasto, '', '', '', '', '');
      ...
      function fnc_Datagrid2_Validar(ControlID, Constante) {
          ...
          //          }
          //DG - FIN
          var ldtbResultado = frm_RegistrarOrdenServicio_3.fnc_ValidarCodigos('', ltxtCuentaGastos.value, ltxtGrupo.value, ltxtTipo.value, ltxtCentroCosto.value, ltxtOrdenServicio.value, '');
          if (ldtbResultado != null && typeof (ldtbResultado) == "object") {
              var ldtbResultadoOk = ldtbResultado.value;
          ...
          if (ltxtCuentaGastos.value != "") {
              var ldtbResultado = frm_RegistrarOrdenServicio_3.ValidarCuentaGastoOT(ltxtCuentaGastos.value);
              var strOrdenServicio2 = ltxtOrdenServicio.value;
              if (strOrdenServicio2.substring(0, 1) != '9') {
...
--%>
                ...
                <tr>
                    <td class="Etiqueta" style="WIDTH: 150px; height:20px" valign="middle" align = "left">¿El 
                        trabajo se realizara en las instalaciones de NM?:</td>
                    <td align="center" class="Etiqueta" style="width:100px">
                ...
                <tr>
                    <td class="Etiqueta" style="WIDTH: 150px; height:20px" valign="middle" align = "left">Visita Técnica<br />
                        Fecha y Horario:</td>
                    <td align="center" class="Etiqueta" style="width:100px">
                        <asp:textbox id="txtFecVisTec" runat="server" Width="73px" CssClass="input"></asp:textbox>
                        &nbsp;<img 
                            onclick="popUpCalendar(this, frmRequisicion.txtFecVisTec, 'dd/mm/yyyy')" 
                            height="16" alt="Seleccionar fecha de Inst." 
                            src="../../intranet/Imagenes/Calendario.gif" border="0" style="width: 16px" runat="server" id="btnCalVisTec"/>
                    </td>
                    <td align="center" class="Etiqueta" style="width:100px">
                        <asp:DropDownList ID="ddlHora" runat="server" Height="25px" Width="122px"
                                AutoPostBack="true">
            ...
            <div runat="server" id="pnlInterno">
            <table cellspacing="2" cellpadding="0" width="900px" border="0">
                ...
                <tr>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">Valor Referencial:</td>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">
                        <asp:DropDownList ID="ddlValReferencial" runat="server" Width="150px" CssClass="input">
                            <asp:ListItem Value="0">---Seleccione Valor----</asp:ListItem>
                            <asp:ListItem Value="1">S/. 0 - S/. 2499</asp:ListItem>
                            <asp:ListItem Value="2">S/. 2500 - S/. 7000</asp:ListItem>
                            <asp:ListItem Value="3">S/. 7001 - (+)</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">Descripcion del trabajo a contratar:</td>
                    <td class="Etiqueta" style="WIDTH: 390px" valign="middle" align = "left" rowspan="3">
                        <asp:textbox id="txtDesTraContra" runat="server" Width="380px" CssClass="input" 
                            MaxLength="300" height="97px" TextMode="MultiLine" Font-Size="10px"></asp:textbox></td>
                </tr>

                <tr>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">Area:</td>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">
                        <asp:DropDownList ID="ddlPlanta" runat="server" Width="150px" CssClass="input" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left" rowspan="2"></td>
                </tr>

                <tr>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">Zona:</td>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">
                        <asp:DropDownList ID="ddlZona" runat="server" Width="150px" CssClass="input">
                        </asp:DropDownList>
                    </td>                   
                </tr>
                <tr>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left">Tipo Trabajo:</td>
                    <td class="Etiqueta" style="WIDTH: 168px" valign="middle" align = "left" colspan="3">
                         <asp:CheckBoxList ID="chkBLTipTrabajo" runat="server" Font-Size="X-Small" 
                             RepeatColumns="2" RepeatDirection="Horizontal" Width="723px">
                        </asp:CheckBoxList>
                    </td>
                </tr>
            </table>
                    ...
                    <asp:datagrid id="DataGrid2" runat="server" Width="990px" ShowFooter="True" AutoGenerateColumns="False" Font-Bold="False">
                        ...
                        <Columns>
		                    ...
		                    <EditItemTemplate>
                                <table id="Table29" style="WIDTH: 90px; HEIGHT: 24px" cellspacing="1" cellpadding="0" border="0">
                                <tr>
                                    <td><asp:TextBox id="txtCodigoOrdenTrabajo_S_E"  ClientIDMode="Static" runat="server" CssClass="input" Width="60px" text='<%#Container.DataItem("NU_ORTR")%>' Font-Size="10px"></asp:TextBox></td>
