...
Public Class frm_RegistroDespachoPedidosDesperdicios
    ...
    Protected Sub btnDespachar_Click(sender As Object, e As EventArgs) Handles btnDespachar.Click
        ...
        Try
            ...
            If Not ldtbDetalle Is Nothing And ldtbDetalle.Rows.Count > 0 Then
                ...
                'DESPERDICIOS
                dtbRetorno = objPedido.fnc_PedidoValesDesperdicios_Grabar(strUsuario, strNumeroPedido)
    ...
    Public Function fncGuardarDetalle() As Boolean
        Dim i As Integer = 0
            ...
            If Not ldtDetalleOriginal Is Nothing Then
                ...
                If max > 0 Then
                    For i = 0 To max - 1
                        ...
                        'txtDespachable = IIf(strCodAlmacen = "015", Nothing, dgDetalle.Items(i).Cells(0).FindControl("txtDespachable"))
                        txtDespachableKgs = dgDetalle.Items(i).Cells(0).FindControl("txtDespachableKgs")

                        'ldblNewCantidad = IIf(strCodAlmacen = "015", 0, Double.Parse(txtDespachable.Text))
                        ...
                        If Not prcActualizaDetalle(strNumeroPedido, strCodArticulo, ldblNewCantidad, ldblNewCantidadKgs, ldblStock, _
                           ldblNewPendiente, strUsuario, strCtaGasto, strOrdenServicio, strCentroCostos) Then
                            Return False
                        End If
    ...
    Private Function prcActualizaDetalle(ByVal strNumPedido As String, ByVal strCodArticulo As String, ByVal ldblNewCantidad As Double, ldblNewCantidadKgs As Double, _
                                    ...
                                    ByVal strCentroCostos As String) As Boolean
        Dim ldtDetalle As New DataTable
        Dim objPedidos As New Logistica.clsPedidos
        ldtDetalle = Nothing
        lblError.Text = ""
        Try
            ...
            If strCodArticulo.Length > 0 Then
                ...
                If ldblNewCantidad >= 0 And ldblNewCantidadKgs >= 0 Then
                    ...
                    If ldblNewCantidadKgs <= ldblNewPendiente Then
                        ...
                        If ldblStock >= ldblNewCantidad Then
                            Try
                                ...
                                ldtDetalle = objPedidos.fncActualizarCantidades("2", strNumPedido, strCodArticulo, _
                                                        ldblNewCantidadKgs, strUsuario, strCtaGasto, strOrdenServicio, strCentroCostos)
                                Return True
                            Catch ex As Exception
                    ...
                    End If
                Else
                    lblError.Text = "Error debe ingresar una cantidad mayor a cero en kgs."
                    Return False
                End If
            Else
    ...
    'Private Sub dgDetalle_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgDetalle.ItemDataBound
    '    If e.Item.ItemType = ListItemType.Item Then
    '        CType(e.Item.FindControl("txtDespachable"), TextBox).Attributes.Add("readonly", "readonly")
    '        CType(e.Item.FindControl("txtDespachable"), TextBox).CssClass = "txtDeshabilitado"
    '    End If
    'End Sub
End Class