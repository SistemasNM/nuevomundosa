...
Public Class frm_RegistrarOrdenServicio_2
...
#Region "-- Eventos --"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        Ajax.Utility.RegisterTypeForAjax(GetType(frm_RegistrarOrdenServicio_2))
    ...
    Public Function CargarMontoOt(ByVal strOT As String) As String
        ...
        If strOT <> "" Then
            ...
            Return Format(Integer.Parse(strMonto), "###,###,###")
        End If
        Return strMonto
    End Function
    ...
    Private Sub BtnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Try
            ...
            If CType(Session("Nuevo"), Boolean) Then
                ...
                ldatable = obj.Insertar_Requisicion_v3(Session("@EMPRESA"), "001", "REQ", Me.txtSerie.Text, "", Mid(txtAlmacen.Text, 1, 3),
            ...
            Else
                ...
                obj.Actualiza_Requisicion_2(Session("@EMPRESA"), "001", "REQ", strNumeroReqi, Mid(txtAlmacen.Text, 1, 3),
