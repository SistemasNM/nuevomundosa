Public Class frm_RptMovimientoTela_Orerarios
    Inherits System.Web.UI.Page

    Private Sub frm_RptMovimientoTela_Orerarios_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        '-----------------------------------------------------------------------
    ...
    Private Sub sMostrarReporte()
        ...
        strURL = strURL + "log_movimiento_tela_operarios"
