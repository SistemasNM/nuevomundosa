<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptIngresoSalidaHilos.aspx.vb" Inherits="intranet_logi.frm_RptIngresoSalidaHilos" %>
   ...
   <asp:UpdatePanel ID="panContenido" runat="server">
    <ContentTemplate>
     ...
     <table border="0" cellspacing="1" cellpadding="1" width="100%">
      <tr>
	   <td align="center" style="HEIGHT:20px;" class="Cabecera">REPORTE&nbsp;DE&nbsp;HILOS</td>
      </tr>
     </table>
                    ...
                    <tr>
                        ...
                        <td align="left" style="WIDTH: 190px;">
                            <asp:RadioButtonList ID="rdlReportes" runat="server" CssClass="input">
                                <asp:ListItem Selected="True" Text="Pendiente de Ingresos" Value="1"></asp:ListItem>
                                <asp:ListItem Selected="False" Text="Ingresos de Hilos" Value="2"></asp:ListItem>
                                <asp:ListItem Selected="False" Text="Despacho de Hilos" Value="3"></asp:ListItem>
                                <asp:ListItem Selected="False" Text="Pre-Despacho de Hilos" Value="4"></asp:ListItem>
                                <asp:ListItem Selected="False" Text="Pendientes de Hilos" Value="5"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td align="left" style="WIDTH: 100px;">
