<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_Reporte_Consumo_EE.aspx.vb" Inherits="intranet_logi.frm_REporte_Consumo_EE" %>
								...
								<table cellspacing="0" cellpadding="0" width="100%" border="0">
									    ...
									    <tr>
                                            ...
                                            <td>
                                                &nbsp;</td>
                                            <td >
                                                &nbsp;<asp:DropDownList ID="ddlMaquinas" runat="server" Width="467px" 
                                                    Height="20px">
                                                </asp:DropDownList>
                                                &nbsp;</td>
                                            <td>
										...
										<tr>
                                            ...
                                            <td align="left">&nbsp;</td>
										    <td align="left">
                                                <table border="0" cellpadding="0" cellspacing="0" style="WIDTH: 500px; HEIGHT: 30px">
                                                    <tr>
                                                        <td style="width:250px"><asp:RadioButton ID="rdbTipoResumido" runat="server" Text="Resumido" 
                                                                Checked="True" GroupName="TIPO_REPORTE"  AutoPostBack="true"/></td>
                                                        <td style="width:250px"><asp:RadioButton ID="rdbTipoDetallado" runat="server" Text="Resumido (Todos los Medidores)" 
                                                                GroupName="TIPO_REPORTE"  AutoPostBack="true" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td align="left">&nbsp;</td>                                            
