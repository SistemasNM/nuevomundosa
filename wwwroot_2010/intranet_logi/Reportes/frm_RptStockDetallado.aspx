<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptStockDetallado.aspx.vb" Inherits="intranet_logi.frm_RptStockDetallado" %>
...
<center>
    ...
    <table class="CabMain" border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td style="width:100%" valign="bottom" align="center" >
                Reporte: Stock Detallado de Muestras y Desperdicios</td>
        </tr>
    </table>
    ...
    <!-- **************  Inicio de Contenido ****************** -->
            ...
            <ContentTemplate>
                    ...
                    <table  border="0" cellpadding="0" cellspacing="0" style="width:243px; height:40px">
                            ...
                            <td style="width: 150px">
								<table cellspacing="0" cellpadding="0" width="100%" border="0">
										...
										<tr>
											<td>&nbsp;</td>
											<td>
                                                <asp:DropDownList ID="ddlAlmacenes" runat="server" Height="18px" Width="170px">
                                                    <asp:ListItem Value="013">Alm.Muestras</asp:ListItem>
                                                    <asp:ListItem Value="015">Alm.Desperdicios</asp:ListItem>
                                                </asp:DropDownList>
											</td>
											<td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>											
											<td>
