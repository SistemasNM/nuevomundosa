<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptAtencionVales.aspx.vb" Inherits="intranet_logi.frm_RptAtencionVales" %>
...
<body>
    ...
    <table class="CabMain" border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td style="width:100%" class="Cabecera">Reporte: Atencion de Vales de Almacen</td>
        </tr>
    </table>
    ...
    <!-- **************  Inicio de Contenido ****************** -->
            ...
            <ContentTemplate>
                    ...
                    <table  border="0" cellpadding="0" cellspacing="0" style="width:300px; height:40px">
                        ...
                        <tr>
                            <td align ="left" >Tipo de Consulta:&nbsp;
                            <asp:DropDownList ID="ddlTipoConsulta" 
                                    runat="server" AutoPostBack="false" CssClass="input" Height="20px" 
                                    Width="180px" Font-Size="9px">
                                <asp:ListItem Value="DET">Detallado</asp:ListItem>
                                <asp:ListItem Value="RES">Resumido</asp:ListItem>
                                </asp:DropDownList>
                                <br />
                            </td>
                            <td>
