<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptPlazodePagoProm.aspx.vb" Inherits="intranet_logi.frm_RptPlazodePagoProm" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td style="width:100%" class="Cabecera" >
                Reporte: Plazo de Pago Promedio</td>
        </tr>
    </table>
								...
								<table cellspacing="0" cellpadding="0" width="100%" border="0">
										...
										<tr>
											<td colspan="6" align="left">
                                                <asp:Label ID="Label1" runat="server" Text="Modelos de Reporte" Font-Underline="True"></asp:Label>
                                            </td>
										</tr>
										<tr>
											<td colspan="6" align="left" nowrap>
                                                <asp:RadioButtonList ID="rbListModelos" runat="server" AutoPostBack="True" 
                                                    ...
                                                    <asp:ListItem Value="1" Selected  Title="Este Modelo lista los Montos por Proveedor y por Forma de Pago.">Modelo 1</asp:ListItem>
                                                    <asp:ListItem Value="2" Title="Este Modelo lista los Montos Consolidados por Forma de Pago.">Modelo 2</asp:ListItem>
                                                </asp:RadioButtonList>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
                                                <ig:WebDatePicker ID="TxtFechaFin" runat="server" Width="110px"></ig:WebDatePicker>											
											</td>
											<td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>											
											<td>
