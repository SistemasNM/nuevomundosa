Public Class frm_RptResumenIngresoDesperdicios
    ...
    Private Sub sMostrarReporte()
        ...
        Select Case rbt_opcion.SelectedValue
            Case 1

                strURL = strURL + strPath + "log_ingreso_desperdicios_resumido"
                strURL = strURL & "&CO_EMPR=" & Session("@EMPRESA")
                strURL = strURL & "&FE_INIC=" & strFe_Inic
                strURL = strURL & "&FE_FINA=" & strFe_Fina
            ...
            Case 2
                ...
                strURL = strURL + strPath + "log_ingreso_desperdicios_x_documento"
                strURL = strURL & "&CO_EMPR=" & Session("@EMPRESA")
                strURL = strURL & "&FE_INIC=" & strFe_Inic
                strURL = strURL & "&FE_FINA=" & strFe_Fina
                strURL = strURL & "&rs:Command=Render"
            ...
            Case 3
                ...
                strURL = strURL + strPath + "log_ingreso_desperdicios_x_fecha"
                strURL = strURL & "&CO_EMPR=" & Session("@EMPRESA")
                strURL = strURL & "&FE_INIC=" & strFe_Inic
                strURL = strURL & "&FE_FINA=" & strFe_Fina
                strURL = strURL & "&rs:Command=Render"
            ...
            Case 4
                ...
                strURL = strURL + strPath + "log_Desperdicios_Tejeduria_Detallado"
                strURL = strURL & "&pdtm_Fecha_Inicio=" & strFe_Inic
                strURL = strURL & "&pdtm_Fecha_Final=" & strFe_Fina
                strURL = strURL & "&rs:Command=Render"
                strURL = strURL + "&rc:Toolbar=true"
                strScript = "fMostrarReporte('" & strURL & "');"
                ScriptManager.RegisterStartupScript(Me, Page.GetType, "ShowInfo", strScript, True)
            ...
            Case 5
                ...
                strURL = strURL + strPath + "log_Desperdicios_Tejeduria_x_procesos"
                strURL = strURL & "&pdtm_Fecha_Inicio=" & strFe_Inic
                strURL = strURL & "&pdtm_Fecha_Final=" & strFe_Fina
                strURL = strURL & "&rs:Command=Render"
                strURL = strURL + "&rc:Toolbar=true"
