<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptProduccionDiaria.aspx.vb" Inherits="intranet_logi.frm_RptProduccionDiaria" %>
...
<body>
    <form id="frm_RptProduccionDiaria" runat="server">
   ...
   <asp:UpdatePanel ID="panContenido" runat="server">
    <ContentTemplate>
     ...
     <table border="0" cellspacing="1" cellpadding="1" width="100%">
      <tr>
	   <td align="center" style="HEIGHT:20px;" class="Cabecera">REPORTE&nbsp;DE&nbsp;PRODUCCIÓN 
           DIARIA</td>
      </tr>
     </table>
                ...
                <table style="WIDTH:580px; HEIGHT: 20px" border="0" cellpadding="0" cellspacing="0">
                    <tr>
	                    ...
	                    <td style="WIDTH: 190px;" align="left">
                            ...
                            &nbsp;<img onclick="popUpCalendar(this, frm_RptProduccionDiaria.txtFechaIni, 'dd/mm/yyyy')" border="0"
                        ...
                        <td style="WIDTH: 190px;" align="left">
                            ...
                            &nbsp;<img onclick="popUpCalendar(this, frm_RptProduccionDiaria.txtFechaFin, 'dd/mm/yyyy')" border="0"
