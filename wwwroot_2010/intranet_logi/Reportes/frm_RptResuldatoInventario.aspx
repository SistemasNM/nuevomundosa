<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptResuldatoInventario.aspx.vb" Inherits="intranet_logi.frm_RptResuldatoInventario" %>
...
<head id="Head1" runat="server" >
 <title>Resultado de Inventario</title>
    ...
    <table class="CabMain" border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td style="width:100%" valign="bottom" align="center" >
                Reporte: Resultado de Inventario</td>
        </tr>
    </table>
