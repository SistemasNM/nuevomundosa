Public Class frm_RptStockDetallado
    ...
    Private Sub sMostrarReporte()
        ...
        Dim strCo_Alma As String

        strCo_Alma = ddlAlmacenes.SelectedValue
        ...
        strURL = strURL + strPath + "log_stock_detallado_almacen"
        strURL = strURL & "&CO_EMPR=" & Session("@EMPRESA")
        strURL = strURL & "&CO_ALMA=" & strCo_Alma
