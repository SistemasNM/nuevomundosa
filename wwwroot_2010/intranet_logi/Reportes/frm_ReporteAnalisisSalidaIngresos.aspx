<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_ReporteAnalisisSalidaIngresos.aspx.vb" Inherits="intranet_logi.frm_ReporteAnalisisSalidaIngresos" %>
    ...
    <form id="frmData" runat="server" method="post" >
        ...
        <center>
            <table style="width:946px" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td class="Cabecera" style="width:900px; height:30px" align="center">REPORTE DE ANALISIS DE INGRESOS/SALIDAS Y CLIENTE</td>
                </tr>
            </table>
            <table id="Table1" style="WIDTH: 946px; HEIGHT: 40px" cellspacing="2" cellpadding="1" width="946" class="FrameSimple" 
                    ...
                    <tr>
                        <td class="Descripcion" style="width:100px">&nbsp;Articulo :</td>
					    <td class="style4" style="width:150px">
						    <asp:textbox id="txtArticulo" runat="server" Width="103px" CssClass="input" 
                ...
                <table style="width:700px">
                    ...
                    <tr>
                        <td>
                            <asp:button Width="95PX" id="btnIngreso" runat="server" CssClass="boton" Text="Ingresos"></asp:button>
                        </td>
                         <td>
                            <asp:button Width="95PX" id="btnSalida" runat="server" CssClass="boton" Text="Salida"></asp:button>
                        </td>
                        <td>
                            <asp:button Width="95PX" id="btnCliente" runat="server" CssClass="boton" Text="Cliente"></asp:button>
                        </td> 
                         <td>
                            <asp:button Width="95PX" id="btnResumen" runat="server" CssClass="boton" Text="Resumen"></asp:button>
                        </td>                          
                    </tr>
                </table>
        </center>
