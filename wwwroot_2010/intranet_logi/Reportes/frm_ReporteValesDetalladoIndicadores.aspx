<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_ReporteValesDetalladoIndicadores.aspx.vb" Inherits="intranet_logi.frm_ReporteValesDetalladoIndicadores" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>Reporte De Vales Con Indicadores</title>
...
<body>
    <form id="Form1" runat="server">
        <table border="0" cellspacing="1" cellpadding="1" width="100%">
          <tr>
	       <td align="center" style="width:800px;HEIGHT:20px;" class="Cabecera">REPORTE&nbsp;DE&nbsp;VALES&nbsp;CON&nbsp;INDICADORES</td>
          </tr>
         </table>
