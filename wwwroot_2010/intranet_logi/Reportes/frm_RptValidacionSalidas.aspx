<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptValidacionSalidas.aspx.vb" Inherits="intranet_logi.frm_RptValidacionSalidas" %>
    ...
    <table class="CabMain" border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td style="width:100%" valign="bottom" align="center" >
                Reporte: Validación de Salidas</td>
        </tr>
    </table>
                            ...
                            <td style="width: 150px">
								<table cellspacing="0" cellpadding="0" width="100%" border="0" 
                                    style="width: 169%">
										...
										<tr>
											<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Numero de Salida:</td>
											<td>
                                                <asp:TextBox ID="txt_nusali" runat="server" Height="21px" Width="50px"></asp:TextBox>
											    </td>
											<td>&nbsp;&nbsp;</td>
											<td>
                                                &nbsp;</td>
