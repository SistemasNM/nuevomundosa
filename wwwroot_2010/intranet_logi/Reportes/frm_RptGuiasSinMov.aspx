<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptGuiasSinMov.aspx.vb" Inherits="intranet_logi.frm_RptGuiasSinMov" %>
    ...
    <table class="CabMain" border="0" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td style="width:100%" class="Cabecera">
                Reporte: Guias Sin Movimientos de Stock</td>
        </tr>
    </table>
								...
								<table cellspacing="0" cellpadding="0" width="100%" border="0">
										<tr>
											<td colspan="6" align="left">
                                                <asp:Label ID="Label1" runat="server" Text="Estado de Guias" 
										...
										<tr>
											<td colspan="6" align="left" nowrap>
                                                <asp:RadioButtonList ID="rbListModelos" runat="server" AutoPostBack="True" 
                                                    ...
                                                    <asp:ListItem Value="1" Selected  Title="Este Modelo lista la Atención de los Pedidos desde la requisión hasta el ingreso almacen.">Por Recoger</asp:ListItem>
                                                    <asp:ListItem Value="2" Title="Este Modelo lista el seguimiento de la Orden de Compra, desde su emisión hasta que es atendido por el Proveedor.">Recogidos</asp:ListItem>
                                                </asp:RadioButtonList>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="6" align="left">
                                                <asp:Label ID="Label3" runat="server" Text="Fecha de Creación" 
                                                    Font-Underline="True"></asp:Label></td>
										</tr>											
										<tr>
											<td colspan="6" align="left">&nbsp;&nbsp;&nbsp;</td>
