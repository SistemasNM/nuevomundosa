<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_RptMovimientoTela_Orerarios.aspx.vb" Inherits="intranet_logi.frm_RptMovimientoTela_Orerarios" %>
   ...
   <asp:UpdatePanel ID="panContenido" runat="server">
    <ContentTemplate>
     ...
     <table border="0" cellspacing="1" cellpadding="1" width="100%">
      <tr>
	   <td align="center" style="HEIGHT:20px;" class="Cabecera">REPORTE&nbsp;DE&nbsp;MOVIMIENTOS DE TELA - 
           OPERARIOS</td>
      </tr>
     </table>
