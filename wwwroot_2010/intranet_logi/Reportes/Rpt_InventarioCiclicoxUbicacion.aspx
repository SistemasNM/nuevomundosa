<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rpt_InventarioCiclicoxUbicacion.aspx.vb" Inherits="intranet_logi.Rpt_InventarioCiclicoxUbicacion" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
		<title>REPORTE DE INVENTARIO CICLICO POR UBICACION</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table id="Table1" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 706px; POSITION: absolute; TOP: 8px; HEIGHT: 64px"
				...
				<tr>
					<td class="style1" id="colTitulo" align="left" runat="Server">&nbsp;REPORTE DE INVENTARIO CICLICO POR UBICACION</td>
				</tr>
				<tr>
					<td>
