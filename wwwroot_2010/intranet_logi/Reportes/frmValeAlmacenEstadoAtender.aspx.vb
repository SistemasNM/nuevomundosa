Public Class frmValeAlmacenEstadoAtender
    ...
    Private Sub sMostrarReporte()
        ...
        strURL = strURL + strPath + "log_vales_almacen_estados"
        strURL = strURL & "&p_vch_fecha_ini=" + Format(CDate(txtFechaIni.Text), "yyyyMMdd")
        strURL = strURL & "&p_vch_fecha_fin=" + Format(CDate(txtFechaFin.Text), "yyyyMMdd")
