...
Public Class rpt_ValeAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "intranet_logi.rpt_ValeAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_intNumPedido() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_ValeAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ValeAlmacen = New rpt_ValeAlmacen()
        rpt.Site = Me.Site
        Return rpt
    End Function
