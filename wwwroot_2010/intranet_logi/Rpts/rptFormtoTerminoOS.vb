...
Public Class rptFormtoTerminoOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "intranet_logi.rptFormtoTerminoOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFormtoTerminoOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormtoTerminoOS = New rptFormtoTerminoOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
