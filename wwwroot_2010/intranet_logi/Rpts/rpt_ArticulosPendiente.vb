...
Public Class rpt_ArticulosPendiente
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_ArticulosPendiente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "intranet_logi.rpt_ArticulosPendiente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_strTipo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_ArticulosPendiente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ArticulosPendiente = New rpt_ArticulosPendiente()
        rpt.Site = Me.Site
        Return rpt
    End Function
