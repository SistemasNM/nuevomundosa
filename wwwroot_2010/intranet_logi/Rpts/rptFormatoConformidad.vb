...
Public Class rptFormatoConformidad
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFormatoConformidad.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "intranet_logi.rptFormatoConformidad.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_chr_Empresa() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_var_OrdenCompraServicio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptFormatoConformidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormatoConformidad = New rptFormatoConformidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
