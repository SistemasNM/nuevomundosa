...
Public Class rpt_AnalisisOC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "intranet_logi.rpt_AnalisisOC.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_strNumeroOrdenCompra() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_AnalisisOC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AnalisisOC = New rpt_AnalisisOC()
        rpt.Site = Me.Site
        Return rpt
    End Function
