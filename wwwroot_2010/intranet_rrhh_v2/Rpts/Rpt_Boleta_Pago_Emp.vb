...
Public Class Rpt_Boleta_Pago_Emp
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Rpt_Boleta_Pago_Emp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Boleta_Pago_Emp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Boleta_Pago_Emp = New Rpt_Boleta_Pago_Emp
        rpt.Site = Me.Site
        Return rpt
    End Function
