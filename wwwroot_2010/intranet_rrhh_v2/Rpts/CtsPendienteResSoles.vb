...
Public Class CtsPendienteResSoles
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CtsPendienteResSoles.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCtsPendienteResSoles
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CtsPendienteResSoles = New CtsPendienteResSoles
        rpt.Site = Me.Site
        Return rpt
    End Function
