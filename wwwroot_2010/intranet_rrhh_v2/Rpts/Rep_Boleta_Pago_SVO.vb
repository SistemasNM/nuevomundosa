...
Public Class Rep_Boleta_Pago_SVO
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Rep_Boleta_Pago_SVO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_Boleta_Pago_SVO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_Boleta_Pago_SVO = New Rep_Boleta_Pago_SVO
        rpt.Site = Me.Site
        Return rpt
    End Function
