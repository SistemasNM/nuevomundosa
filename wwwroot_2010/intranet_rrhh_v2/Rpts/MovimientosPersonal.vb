...
Public Class MovimientosPersonal
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "MovimientosPersonal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TI_PROC As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedMovimientosPersonal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MovimientosPersonal = New MovimientosPersonal
        rpt.Site = Me.Site
        Return rpt
    End Function
