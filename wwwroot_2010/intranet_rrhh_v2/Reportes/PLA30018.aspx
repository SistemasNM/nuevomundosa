<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PLA30018.aspx.vb" Inherits="intranet_rrhh.PLA30018" %>
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<table id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px; HEIGHT: 32px"
				...
				<tbody>
					<tr>
						<td class="Cabecera" style="BACKGROUND-IMAGE: url(http://localhost/intranet/Imagenes/Cabecera.bmp)">MINTRA - Formulario 3 
                           </td>
					</tr>
					<tr>
							...
							<table id="Table2" style="WIDTH: 772px; HEIGHT: 28px" cellspacing="1" cellpadding="1"
								...
								<tbody>
									<tr>
                                        ...
                                        <asp:dropdownlist id="ddlPlanilla" runat="server" Height="16px" Width="150px" 
