<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_LicenciasPendientes.aspx.vb" Inherits="intranet_rrhh.frm_LicenciasPendientes" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
 <title>Licencias pendientes a la fecha</title>
 ...
 <form id="frm_LicenciaFecha" runat="server">
  <div>
   <table style="width:800px" cellspacing="0" cellpadding="0" border="0">
	  <tr>
	   <td class="titulo" style="width:800px; height:20px" align="center">LISTADO DE LICENCIAS PENDIENTES</td>
	  </tr>
    <tr>
