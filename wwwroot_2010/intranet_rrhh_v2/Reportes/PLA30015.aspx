<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PLA30015.aspx.vb" Inherits="intranet_rrhh.PLA30015" %>
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<table id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px; HEIGHT: 32px"
				...
				<tbody>
					<tr>
						<td class="Cabecera" style="BACKGROUND-IMAGE: url(http://localhost/intranet/Imagenes/Cabecera.bmp)">Cálculo de Subsidios 
						</td>
					</tr>
					<tr>
						<td class="panel" rowspan="2">
							<table id="Table2" style="WIDTH: 772px; HEIGHT: 28px" cellspacing="1" cellpadding="1"
								...
								<tbody>
									<tr>
										<td class="Etiqueta" style="WIDTH: 50px; HEIGHT: 20px">Código</td>
										<td style="WIDTH: 100px; HEIGHT: 20px">
                                            <asp:textbox id="txtCodigo" runat="server" 
                                                MaxLength="5" Height="14px" Width="40px" Font-Names="Verdana"
												Font-Size="XX-Small" CssClass="TextoCentrado"></asp:textbox></td>
										<td class="style1">Año</td>
										<td style="WIDTH: 100px; HEIGHT: 20px">
                                            <asp:textbox id="txtAnio" runat="server" 
                                                MaxLength="5" Height="14px" Width="30px" Font-Names="Verdana"
												Font-Size="XX-Small" CssClass="TextoCentrado"></asp:textbox></td>
										...
										<td class="style2">Dias Subsidio</td>
										<td style="WIDTH: 150px; HEIGHT: 21px">
                                            <asp:textbox id="txtDiasSubs" runat="server" 
                                                MaxLength="3" Height="14px" Width="20px" Font-Names="Verdana"
												Font-Size="XX-Small" CssClass="TextoCentrado"></asp:textbox></td>
										<td style="WIDTH: 150px; HEIGHT: 21px">
