...
#Region "-- Metodos --"
    Private Sub sMostrarReporte()
        ...
        strURL = strURL + strPath + "pla_planilla_anual"
        strURL = strURL + "&CO_EMPR=" + Session("@EMPRESA")
        strURL = strURL + "&CO_TRAB=" + Me.txtCodigo.Text
        strURL = strURL + "&AA_INICIO=" + Me.txtAnio.Text
        strURL = strURL + "&MM_FINAL=" + ddlMes.SelectedValue
        strURL = strURL + "&NU_DISUB=" + txtDiasSubs.Text
