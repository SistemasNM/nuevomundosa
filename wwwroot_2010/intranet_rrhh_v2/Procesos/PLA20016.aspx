<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PLA20016.aspx.vb" Inherits="intranet_rrhh_v2.PLA20016" %>
	...
	<body>
		<form id="frmHESolicitud" name="frmHESolicitud" method="post" runat="Server">
			...
			<table id="Table4" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px" cellspacing="2"
				...
				<tr>
					<td class="cabecera" style="HEIGHT: 22px">&nbsp;RENOVACION DE CONTRATOS</td>
				</tr>
				<tr>
					<td class="panel">
						<table style="WIDTH: 1020px; HEIGHT: 39px" cellspacing="0" cellpadding="0">
							<tr>
								<td>Año:&nbsp; 
                                    <asp:textbox id="txtAnio" runat="server" MaxLength="4" Height="20px" 
                                        Width="35px" Font-Names="Verdana"
										Font-Size="XX-Small" style="margin-top: 0px"></asp:textbox>&nbsp;&nbsp;&nbsp; Mes:&nbsp;
                                    <asp:DropDownList ID="ddlMes" runat="server" Width="142px" Height="21px">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:button id="btnProcesar" runat="server" CssClass="Boton" Text="Procesar"></asp:button></td>
							</tr>
							<tr>
								<td>&nbsp;&nbsp;
									&nbsp;
						...
						<table>
							<tr>
								<td><asp:datagrid id="dgdDetalle" runat="server" Width="1008px" ShowFooter="True" 
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="Apellidos y Nombres">
											...
											<asp:TemplateColumn HeaderText="Area">
												...
												<FooterTemplate>
													<asp:TextBox id="txtFechaF" runat="server" CssClass="Input" Width="80px" Height="20px"></asp:TextBox>&nbsp;<img onclick="popUpCalendar(this, <%# Container.ClientID %>_txtFechaF, 'dd/mm/yyyy')" height=15 alt="Seleccionar fecha" src="../../intranet/Imagenes/Calendario.gif" width=13 border=0>
												</FooterTemplate>
												<EditItemTemplate>
													<asp:TextBox id="txtFechaE" runat="server" CssClass="Input" Width="80px" Height="20px" text='<%# Container.DataItem("chr_fecha_sol") %>'>
													</asp:TextBox>&nbsp;<img onclick="popUpCalendar(this, <%# Container.ClientID %>_txtFechaE, 'dd/mm/yyyy')" height=15 alt="Seleccionar fecha" src="../../intranet/Imagenes/Calendario.gif" width=13 border=0>
												</EditItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderText="Inicio Contrato">
											...
											<asp:TemplateColumn HeaderText="Fin Contrato">
												<HeaderStyle HorizontalAlign="Center" Width="200px"></HeaderStyle>
												<ItemTemplate>
