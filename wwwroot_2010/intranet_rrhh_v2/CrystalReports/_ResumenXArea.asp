...
reportname = "../Rpts/ResumenXArea.rpt"
...
Dim  strEmpresa,strAnio,strMes,strFecha
...
Params.Item(2).SetCurrentValue (cint(strAnio))
Params.Item(3).SetCurrentValue (cint(strMes))
Params.Item(4).SetCurrentValue (strFecha)

'response.write strempresa + " " + stranio+"  "+ strmes+"  "+strfecha
