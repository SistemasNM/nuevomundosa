...
reportname = "../Rpts/AdelantoVacResumen.rpt"
...
Dim strEmpresa, strAnno, strMes, strPlan, strProc

strEmpresa=request.QueryString("strEmpresa")
strAnno=request.QueryString("strAnno")
strMes=request.QueryString("strMes")
strPlan = request.QueryString("strPlan")
strProc = request.QueryString("strProc")

Params.Item(1).SetCurrentValue (strEmpresa)
Params.Item(2).SetCurrentValue (strAnno)
Params.Item(3).SetCurrentValue (strMes)
Params.Item(4).SetCurrentValue (strPlan)
Params.Item(5).SetCurrentValue (strProc)

'response.write strEmpresa + " " + strAnno +"  "+ strMes+"  "+strPlan+"  "+strProc
