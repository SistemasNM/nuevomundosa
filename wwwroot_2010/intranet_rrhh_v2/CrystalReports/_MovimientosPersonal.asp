...
reportname = "../Rpts/MovimientosPersonal.rpt"
...
Dim strFecha, strEmpresa

strFecha=request.QueryString("strFecha")
strEmpresa = request.QueryString("strEmpresa")

Params.Item(1).SetCurrentValue ("R")
Params.Item(2).SetCurrentValue (strEmpresa)
Params.Item(3).SetCurrentValue (strFecha)
